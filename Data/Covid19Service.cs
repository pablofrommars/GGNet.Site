...
namespace GGNet.Site.Data
{
    public class Covid19Service
    {
        ...
        public async Task<List<TS>> GetDataAsync()
        {
            ...
            var csv = await client.GetStringAsync("https://raw.githubusercontent.com/owid/covid-19-data/master/input/ecdc/releases/latest.csv").ConfigureAwait(false);
